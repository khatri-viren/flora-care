  ...
  return (
    <section className='mx-5 lg:mx-20 text-udark my-20'>
        <div className="headingsContainer flex flex-col space-y-2 my-10 text-udark">
            ...
            <h2 className='mx-auto text-center text-3xl font-bold'>Meet Our Team</h2>
            <p className='w-1/2 mx-auto text-center text-sm'>Our team members are experts in IoT, plant care, and data analytics.</p>
        </div>
