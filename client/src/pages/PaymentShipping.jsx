    ...
    <div className="mx-5 pt-8 lg:mx-20 my-12 text-udark flex flex-col">
      ...
      <form action="" method="post">
        ...
        <div className="container">
          ...
          <label className="ml-1 mr-5 font-semibold" htmlFor="cod">
            Cash on Delivery
          </label>
          <input
            type="radio"
            ...
            value="netBanking"
          />
          <label className="ml-1 mr-5 font-semibold" htmlFor="netBanking">
            Net Banking
          </label>
          <input type="radio" name="paymentMethod" id="card" value="card" />
          <label className="ml-1 mr-5 font-semibold" htmlFor="card">
            Credit/ Debit Card
          </label>
        </div>
        <div className="flex">
          <button
            type="submit"
            className="py-3 px-10 mt-12 border border-solid border-udark mx-auto font-semibold"
          >
            Proceed
          </button>
        </div>
