      ...
      <div className="grid lg:grid-cols-2 lg:gap-16">
        <div className="leftSide">
          ...
          <div className="flex flex-col mb-5">
            ...
            <textarea name="desc" className="uinput lg:mb-32" id="" cols="30" rows="10"></textarea>
            </div>
        </div>
        ...
        <div className="flex flex-col my-2">
            <button type='submit' className="py-2 px-4 bg-ubg border border-solid border-udark font-semibold">Add Product</button>
        </div>
        </div>
      </div>
    </div>
